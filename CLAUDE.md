# Arc Insights — guidance for Claude Code
...
- `docs/ROADMAP.md` — **static plan** with task IDs (P0-01 through P6-07). Rarely changes.
- `docs/PROGRESS.md` — **live status** of every task. Updated every commit. **Canonical for status.**
...
- `docs/UX-SPEC.md` — dashboard builder UX requirements (binding)
- `docs/AI-SURFACES.md` — every place AI is used + privacy guarantees
- `docs/adr/` — Architecture Decision Records (binding decisions)
- `CONTRIBUTING.md` — developer workflow and PR conventions

> **Status rule:** `PROGRESS.md` is the single source of truth for task status. `ROADMAP.md` lists tasks but does not track status. If they disagree, trust `PROGRESS.md` and ignore `ROADMAP.md` for status questions.
