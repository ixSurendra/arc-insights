...
### Changed (docs alignment)

- FEATURES.md: 147 → **157 features**. New lines covering the 20-page UI surface that wasn't fully backed: Connection setup wizard (§1, P1), Query history with runtime+cache+plan visibility (§2, P1), Full lineage graph with impact analysis (§3, P2), Overview hub + Scheduled export history (§5, P1), AI conversation history & threading (§7, P2), Alert history & incident timeline (§11, P1), Tenant admin UI + Workspace settings admin UI (§14, P1), API key management UI (§16, P1). Priority counts: P0 38, P1 53→61, P2 43→45, P3 13.
- ROADMAP.md + PROGRESS.md: pulled `Public tokenized share links` out of Phase 5 (was P5-06) into **Phase 1 as P1-14** since FEATURES §8 says P1 priority. Phase 5 renumbered P5-06..P5-09 (was P5-07..P5-10). Phase 1 EXIT review moves from P1-14 to P1-15. Phase 1 grows 14 → 15 tasks; Phase 5 shrinks 10 → 9; total still 80 tasks across 7 phases.
- FEATURES.md: added a header note clarifying that not every P1 feature has a ROADMAP task ID — P1 = "first 6 months" spans Phase 1 and Phase 2; tasks get IDs when scope is sized.
