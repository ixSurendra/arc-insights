 ...
 */
import { pgTable, uuid, text, timestamp, varchar, boolean, index, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const users = pgTable(
  ...
  (table) => ({
    ...
    emailTenantUnique: uniqueIndex('users_email_tenant_unique').on(table.tenantId, table.email),
  }),
);
